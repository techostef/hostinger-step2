    ...
    <div class="container m-auto py-3">
        ...
        <div class="w-full flex flex-wrap xm:p-3">
            <div class="xm:w-full w-1/2">
                ...
                <div class="w-full flex py-1 mb-4">
                    <div class="text-dark pl-2 pt-1" style="font-size: 12px">
...
<style>
    .logophplaravel {
        background: url("assets/svg/illustration banner support laravel hosting.svg");
